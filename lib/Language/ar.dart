const Map<String, String> ar = {
  ...
  "AboutTextTwo":
      "مجموعة واسعة من المنتجات: يقدم لکم تطبيقنا دلي لاس مجموعة واسعة من المنتجات، بدءا من المنتجات الطازجة وحتى مستلزمات المؤن والأدوات المنزلية ومنتجات العناية الشخصية والمزيد. يمكنك تصفح الفئات المختلفة والعثور على كل ما تحتاجه في  مكان واحد.",
  "AboutTextThree":
      "واجهة سهلة الاستخدام:يتميز موقع دلي لاس بواجهة سهلة الاستخدام لجعل تجربة التسوق الخاصة بكم مريحة و ممتعة. و يمنحك هذا التطبيق ميزة البحث عن المنتجات بشكل سريع وفعال و إضافتها الى سلة التسوق. ويمكنك المتابعة إلى إتمام عملية الشراء ببضع كليكات فقط.",
  "AboutTextFour":
      "الدفع الآمن: ضمان دفع آمن و موثوق في تطبيق دلي لاس ، نضع أمن المعاملات المالية على رأس أولوياتنا. يوظف تطبيقنا بوابة دفع آمنة متطورة لحماية معاملاتك، مما يضمن دفعا آمنا.",
  "AboutTextFive":
      "العروض والصفقات: ترقبوا العروض الحصرية والخصومات والصفقات المميزة المتاحة على التطبيق دلي لاس ! نلتزم بمساعدتكم على تحقيق توفير كبير في احتياجاتكم التسوقية اليومية. فلا تفوتوا هذه الفرصة",
  "AboutTextSix":
      "دعم العملاء : إذا كانت لديك أي أسئلة أو كنت بحاجة إلى مساعدة، فإن فريق دعم العملاء المخصص لدينا موجود لمساعدتك. يمكنك التواصل معنا عبر التطبيق، وسنعمل على معالجة مخاوفك على الفور.",
  "AboutTextSeven":
      "آراؤكم وتطويرنا: نقدر ملاحظاتكم بقدر كبير. فاقتراحاتكم تساعدنا على تطوير تطبيقنا وخدماتنا. نحن نسعى دائمًا للبحث عن طرق للتحسين وتقديم أفضل تجربة ممكنة لكم.",
  "AboutTextEight":
  ...
  "Good": "جيد",
  "Excellent": "ممتاز",
  "Share your Feedback": "شاركونا آرائكم",
  "Your feedback helps us improve": "آرائكم تساعدنا لنكون افضل",
  "Please slecte stars": "الرجاء قیم بالنجوم",
  "Leave Your Comments": "اكتب تعليقاتك",
  "feedback is require": "آرائكم مطلوبة",
  "Add your Feedback": "اكتب آرائك",
  "Enjoying the app?": "هل انت مستمتع بالتطبيق؟",
  "Would you mind rating us?": "هل تمانع في تقييمنا؟",
  "Rate us in": "قيمنا في",
  ...
  "VALUE": "قيمة",
  "Point": "نقطة",
  "You buy voucher code": "لقد اشتريت رمز قسيمة",
  "Buy Now": "اشتري الآن",
  ...
  "You are offline, connect to a network.": "أنت غير متصل بالإنترنت، قم بالاتصال بالشبكة",
  ...
  "Thursday": "الخميس",
  "Friday": "الجمعة",
  "Checkout": "الدفع و التوصيل",
  "Delivery to": "توصیل الی",
  "Please select Address": "الرجاء حدد عنوان التوصيل",
  "Add location": "إضافة موقع",
  "Change": "تغیر",
  "Delivery Type": "نوعیة التوصيل",
  "Delevery now": "توصيل الآن",
  "Delevery schedule": "تحديد موعد للتوصيل",
  "Today": "اليوم",
  "Select Day to show time deleverys": "اختر تاريخ التوصيل",
  "Select the Time please": "اختر وقت التوصيل",
  "Select": "اختر",
  "Voucher Code": "رمز القسیمة",
  "Please select Your Voucher": "الرجاء اختیار القسیمة",
  "must order by": "یستخدم بعد الطلب بقیمة",
  "Voucher": "قسیمة",
  "Submit": "تقدیم",
  "Add your note": "أضف ملاحظاتك",
  "Note": "ملاحظة",
  "Payment deatils": "تفاصیل الدفع",
  "Sub Total": "المجموع الجزئي",
  "Voucher Amount": "مقدار القسیمة",
  ...
  "Verification": "التحقق",
  "Please enter the 6 digit code sent to": "یرجی ادخال الرمز المكون من ٦ ارقام الذي ارسل الی",
  ...
  "personal data content":
      """أثناء استخدام خدمتنا، قد نطلب منك توفير بعض المعلومات الشخصية التي يمكن استخدامها للتواصل معك أو تحديد  قد تشمل هذه المعلومات، على سبيل المثال:
اسمك و اسم ابوك
رقم الهاتف
العنوان، محافظة
بيانات الاستخدام""",
  ...
  "Usage Data content":
      """تُجمع بيانات الاستخدام تلقائيًا عند استخدام الخدمة، وقد تتضمن معلومات مثل نوع جهازك، نظام التشغيل، الصفحات التي تزورها على تطبيق، ووقت وتاريخ زيارتك، والوقت الذي قضيته على تلك الصفحات.""",
...
معالجة وتحقيق طلبات الخاصة بك
تقديم الدعم العملاء
تحسين تطبيقنا وخدماتنا
إرسال إشعارات لك حول العروض وحالة الطلب""",
  "Sharing Your Information & Your Privacy Choices and Data Retention":
      "نشر معلوماتك وخيارات الخصوصية الخاصة بك والاحتفاظ بالبيانات",

  "Sharing Your Information": "تبادل المعلومات الخاصة بك",
  "Sharing Your Information content":
      """قد نشارك معلوماتك مع الأطراف الثالثة التالية:
 موظفي التوصيل: قد نشارك اسمك ورقم هاتفك مع موظفي التوصيل العاملين لدينا للغرض الحصري من توصيل مشترياتك. يُمنع هؤلاء الموظفون من استخدام معلوماتك لأي غرض آخر ويخضعون لسياساتنا الصارمة في مجال أمان البيانات والخصوصية. يرجى ملاحظة أن هؤلاء الموظفين غير تابعين لأي شركات أخرى ومكرسون بشكل كامل لتنفيذ طلباتك من خلال خدمتنا.
 السلطات القانونية: قد نكشف عن معلوماتك للسلطات القانونية إذا كنا ملزمين بفعل ذلك بموجب القانون أو إذا كنا نعتقد أن مثل هذا الكشف ضروري لحماية حقوقنا أو حقوق الآخرين.""",

  "Your Privacy Choices": "اختيارات خصوصيتك",
  "Your Privacy Choices content":
      """لديك الخيارات التالية بخصوص معلوماتك الشخصية:
 يمكنك الوصول إلى معلوماتك الشخصية وتحديثها عند تسجيل الدخول إلى حسابك على التطبيق.
 سحب موافقتك على استخدامات معينة لمعلوماتك.
حذف معلوماتك: يمكنك حذف جميع معلوماتك الشخصية بسهولة.""",

  "Data Security": "الأمانة البيانية",
  "Data Security content":
      """نتخذ إجراءات أمنية لحماية معلوماتك من الوصول غير المصرح به أو الاستخدام أو الكشف. تتضمن هذه التدابير التشفير وضوابط الوصول.""",

  "Data Retention": "الاحتفاظ بالبيانات",
  "Data Retention content":
      """نحتفظ باسمك ورقم هاتفك لمدة شهر واحد بعد حذف حسابك لتسهيل الاستفسارات المتعلقة بالطلب، والوفاء بالالتزامات القانونية، والسماح لك بتسجيل الدخول مرة أخرى إلى التطبيق دون إعادة التسجيل. يتم حذف جميع المعلومات الأخرى، مثل الجنس والعمر والموقع، تلقائيًا عند حذف الحساب.""",
  "additional information & Permissions and Compliance with Laws":
      "معلومات وأذونات إضافية والامتثال للقوانين",
  "additional information": "معلومات إضافية",
  "additional information content": """ نحن لا نبيع أي بيانات شخصية.
 نحن نستخدم معلومات الموقع فقط بموافقتك ولغرض توصيل طلبات الخاصة بك.
 نحن لا نكشف عن البيانات الشخصية إلا عند الضرورة لتقديم الخدمة أو عندما تكون القوانين المعمول بها مطلوبة.""",

  "Permissions": "الأذونات",
  "Permissions content":
      """ إذن الموقع: نطلب إذن موقعك لنقدم ميزات مثل محدد المتجر وتتبع التسليم. يمكنك تعطيل تصريح الموقع في إعدادات جهازك.
 إذن التخزين: نطلب إذنك للوصول إلى تخزين جهازك لتحميل صورة الملف الشخصي الاختيارية إلى حسابك.
 إذن الإشعار: نطلب تصريح الإشعار لإرسال تحديثات الطلب وإشعارات التسليم. يمكنك إدارة إعدادات الإشعار في إعدادات جهازك.""",

  "Compliance with Laws": "الامتثال للقوانين",
  "Compliance with Laws content":
      """تم تصميم سياسة الخصوصية هذه للامتثال لقوانين ولوائح حماية البيانات السارية، مثل لائحة الحماية العامة للبيانات (GDPR) وقانون خصوصية المستهلكين في كاليفورنيا (CCPA).""",

  "Effective Date": "تاريخ الاصدار",
  "Effective Date content":
      "تعتبر سياسة الخصوصية هذه سارية اعتبارًا من [4 يناير 2024].",
  "Changes to Privacy Policy": "تغييرات في سياسة الخصوصية",
  "Changes to Privacy Policy content":
      """قد نقوم بتحديث سياسة الخصوصية هذه من وقت لآخر. إذا قمنا بإجراء أي تغييرات مهمة، سنُعلمك من خلال التطبيق.
""",
  ...
  "Terms and Condition for Dlly Las Grocery App content":
      """تتحكم هذه الشروط والأحكام في الاستخدامك لتطبيق دلي لاس.
ملحوظة: بالوصول أو استخدام تطبيق "دلي لاس"، يُعتبر ذلك اتفاقك على الالتزام بجميع الشروط والأحكام التالية. إذا كنت غير موافق على هذه الشروط والأحكام، يرجى الامتناع عن استخدام التطبيق أو الموقع.""",

  "General:": "عام:",
  "General: content":
      """• يجب أن تكون على الأقل في الرابعة عشرة من عمرك لاستخدام التطبيق.
• توافق على استخدام التطبيق فقط للأغراض المقصودة.
 • للتسجيل أو تسجيل الدخول إلى التطبيق، يجب على العملاء استخدام نظام كلمة المرور لمرة واحدة (OTP) للتحقق.
• نحتفظ بالحق في إلغاء أو تعديل الطلبات في أي وقت.""",

  "Delivery:": "توصيل:",
  "Delivery: content": """• سيكون توصيل جميع العناصر مجانيًا.
•  سنقوم بتوصيل مشترياتك إلى العنوان الذي تقدمه. 
• أنت مسؤول عن التواجد لاستلام طلبك. 
• الحد الأدنى للطلب للتأهل للحصول على خدمة التوصيل المجاني هو 10000 دينار عراقي.""",

  "Returns and Refunds:": "المرتجعات والاسترجاعات:",
  "Returns and Refunds: content":
      """• عند استلام طلبك، يمكنك طلب إرجاع أي عناصر من قائمة طلبك قبل مغادرة السائق.
• بمجرد تقديم طلب إرجاع لأي عناصر من قائمة طلبك، سنقوم بإعادة المبلغ كاملاً عند تسليم الطلب من قبل السائق.""",

  "Payment:": "الدفع:",
  "Payment:content":
      "• سنوسع قريبًا خيارات الدفع لدينا لتشمل معظم بطاقات الائتمان الرئيسية.",

  "Privacy:": "خصوصية:",
  "Privacy:content": """• نقوم بجمع معلومات معينة عنك عند استخدام التطبيق.
• نستخدم هذه المعلومات لتوفير تجربة أفضل لك.
• لن نشارك معلوماتك مع أطراف ثالثة دون موافقتك.""",

  "Content Protection:": "حماية المحتوى:",
  "Content Protection:content":
      """يُمنع بشكل صارم إعادة نشر أي محتوى أو وصف للعناصر يتم العثور عليها داخل منصة "دلي لاس" بدون إذننا الكتابي الصريح. ويشمل ذلك قوائم المنتجات والصور وأي معلومات أخرى نقدمها على المنصة.""",

  "Changes to Terms and Conditions:": "تغييرات في الشروط والأحكام: ",
  "Changes to Terms and Conditions:content":
      """للبقاء على اطلاع دائم مع التطورات في الخدمات والمتطلبات القانونية، قد نقوم بتحديث شروطنا وأحكامنا بشكل دوري. ستتلقى إشعارًا مباشرًا من خلال رسالة منبثقة داخل التطبيق في كل مرة يتم فيها تحديث الشروط. إذا كانت لديك أي أسئلة، يمكنك الرجوع إلى صفحة الشروط والأحكام المخصصة لدينا أو الاتصال بفريق الدعم الخاص بنا.
""",

  "Governing Law:": "القانون الساري: ",
  "Governing Law:content": "تخضع هذه الشروط والأحكام لسيادة القوانين العراقية.",

  "Contact Us:TC": "اتصل بنا:",
  "Contact Us:TC content":
      """إذا كان لديك أي أسئلة حول هذه الشروط والأحكام، يرجى الاتصال بنا على [Info@Dllylas.com] أو باستخدام هذا رقم الهاتف (+964 750 958 3333).""",
};
