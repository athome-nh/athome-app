const Map<String, String> kur = {
  ...
  "sorryWeDoNotHaveDelivery": "کڕیاری بەڕێز، لە ئێستادا گەیاندنمان بەردەست نیە . ئایا دەتوێت بەیانی داواکارییەکە وەربگریت؟",
  "OK": "دڵنیام",
  ...
  "min deatil": "بۆ بەدەست هێنانی گەیاندنی خۆڕایی تکایە بە بڕی 10000دینار بازاری بکە",
  ...
  //
  "nawy page":"داواکاریەکەت بە سەرکەوتویی وەرگیرا",
  "Yes i Agree":"بەڵێ",
