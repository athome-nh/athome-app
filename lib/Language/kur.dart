const Map<String, String> kur = {
  ...
  "sorryWeDoNotHaveDelivery":
      "ببورن، لە ئیستا گەیاندمان بەردەست نیە هەوڵ دەدەین لە ڕۆژی داهاتوو گەیاندن ئەنجام بدەین لە زووترین کاتدا. هەرەوەها دەتوانن داواکاریەکەتان بگەڕێننەوە پێش قبوڵ کردنی لەلایەن سەرپەرشتیار",
  "OK": "دڵنیام",
