const Map<String, String> kur = {
  ...
  "You need login to add item to favourite":"بۆ زیاد کردنی کاڵای دڵخواز لە پێشدا خۆت تۆمار بکە",
  "Clear": "پاک کردنەوە",
  ...
  "Account is disable please contact athome admin":"هەژمارەکە ڕاگیرا ، پەیوەندی بە سەرپەرشتیاری ئات هۆم بکە",
