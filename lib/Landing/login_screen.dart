                  ...
                  Column(
                    children: [
                      ...
                      Text(
                        "Now",
                        style: TextStyle(
                            fontSize: 70, fontFamily: mainFontMontserrat7),
                      ),
                    ],
                  ),
                  Icon(
              ...
              Center(
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      String ph = PhoneController.text.trim();

                      if (ph.startsWith("0")) {
                        ph = countryController.text.trim() +
                            ph.substring(1, ph.length);
                      }else{
                         {
                        ph = countryController.text.trim() +
                            ph;
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => OtpScreen(phone_number: ph)),
                      );
                    },
                    child: Text(
                      "Send",
