                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Text(
                                                    lang == "en"
                                                        ? textCount(  cartitem.nameEn.toString(), 15) 
                                                        : lang == "ar"
                                                            ? textCount(  cartitem.nameAr.toString(), 15)
                                                            : textCount(  cartitem.nameKu.toString(), 15),
                                                    maxLines: 2,
                                                    style: TextStyle(
                                                        color: mainColorGrey,
                                                        fontFamily:
                                                ...
                                                Column(
                                                  children: [
                                                    Text(
                                                      "${cartitem.price!} IQD",
                                                      style: TextStyle(
                                                          decoration: cartitem.offerPrice! > -1
                                                ...
                                                Row(
                                                  children: [
                                                    Text(
                                                      lang == "en"
                                                          ? textCount(  cartitem.contentsEn.toString(), 15)                                                            
                                                          : lang == "ar"
                                                              ? textCount(  cartitem.contentsAr.toString(), 15) 
                                                              : textCount(  cartitem.contentsKu.toString(), 15),
                                                      style: TextStyle(
                                                          color:
                                                              mainColorGrey,
                                                          fontFamily:
