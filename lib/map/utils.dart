...
//   map.MapboxStyles.MAPBOX_STREETS,
//   map.MapboxStyles.OUTDOORS,
//   map.MapboxStyles.LIGHT,
//   map.MapboxStyles.DARK,
//   map.MapboxStyles.SATELLITE_STREETS
// ];
...
// // extension AnnotationCreation on map.PointAnnotationManager {
// //   addAnnotation(Uint8List imageData, Point position, {String textField = ""}) {
// //     return create(map.PointAnnotationOptions(
// //         geometry: position,
// //         textField: textField,
// //         textOffset: [0.0, -2.0],
...
// extension PuckPosition on map.StyleManager {
...
//     }
//     final location = (layer as map.LocationIndicatorLayer).location;
//     return Future.value(Position(location![1]!, location[0]!));
//   }
// }

// extension PolylineCreation on map.PolylineAnnotationManager {
//   addAnnotation(List<Position> coordinates) {
//     return map.PolylineAnnotationOptions(
//         geometry: map.LineString(coordinates: coordinates),
